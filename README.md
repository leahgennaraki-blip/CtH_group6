...
Overall, what this dataset illustrates is that conscious emotional register does not always reflect the significance of meaning. A word that does not consciously "feel" partiularly happy or sad can be one that people have invested their entire being in (an interesting example is "home", a word perhaps neutral to a privileged person but infinitely emotionally charged for a houseless individual or displaced populations).
