...
To ensure that the dataset was loaded and processed correctly, we performed several basic sanity checks: 
1. we confirmed that no duplicated words appear in the dataset, indicating that each entry in the lexicon is unique.
